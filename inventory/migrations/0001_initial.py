...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_inventoryitem', (
            ...
            ('stocking_uom', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ...
        db.create_table(u'inventory_inventorytag', (
            ...
            ('lot_number', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vendors.Vendor'])),
    ...
    models = {
        u'inventory.inventoryitem': {
            ...
            'stocking_uom': ('django.db.models.fields.CharField', [], {'max_length': '4'}),
        ...
        u'inventory.inventorytag': {
            ...
            'lot_number': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
